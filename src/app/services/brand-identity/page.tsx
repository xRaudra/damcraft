...
export const metadata: Metadata = {
  title: "Brand Identity — Damcraft",
  description: "Logos, visual systems, and brand guidelines built to last. Damcraft brand identity services.",
};
      ...
      <section style={{ background: "#1A0E08", padding: "80px 0 100px" }}>
        <div className="wrap">
          ...
          <h1 style={{ fontFamily: "Raleway, sans-serif", fontWeight: 800, fontSize: "clamp(40px, 5.5vw, 72px)", color: "#FAFAF8", lineHeight: 1.05, marginBottom: "24px", maxWidth: "700px" }}>
            A mark built<br />
            <span style={{ color: "#FF5300" }}>to last.</span>
          </h1>
          <p style={{ fontFamily: "DM Sans, sans-serif", fontSize: "clamp(16px, 1.8vw, 19px)", color: "#F3EBE1", opacity: 0.6, lineHeight: 1.8, maxWidth: "520px" }}>
            Logos, systems, and guidelines that hold their integrity across every surface and scale — from billboard to favicon, print to screen.
          </p>
        </div>
      </section>
