...
export const metadata: Metadata = {
  title: "UI / UX Design — Damcraft",
  description: "Digital interfaces engineered for clarity and longevity. Damcraft UI/UX design services.",
};
      ...
      <section style={{ background: "#1A0E08", padding: "80px 0 100px" }}>
        <div className="wrap">
          ...
          <h1 style={{ fontFamily: "Raleway, sans-serif", fontWeight: 800, fontSize: "clamp(40px, 5.5vw, 72px)", color: "#FAFAF8", lineHeight: 1.05, marginBottom: "24px", maxWidth: "700px" }}>
            Zero waste,<br />
            <span style={{ color: "#FF5300" }}>zero guesswork.</span>
          </h1>
