...
export const metadata: Metadata = {
  title: "Product Design — Damcraft",
  description: "End-to-end product design for digital platforms. Strategy, wireframes, high-fidelity — built to ship.",
};
      ...
      <section style={{ background: "#1A0E08", padding: "80px 0 100px" }}>
        <div className="wrap">
          ...
          <h1 style={{ fontFamily: "Raleway, sans-serif", fontWeight: 800, fontSize: "clamp(40px, 5.5vw, 72px)", color: "#FAFAF8", lineHeight: 1.05, marginBottom: "24px", maxWidth: "700px" }}>
            From strategy<br />
            <span style={{ color: "#FF5300" }}>to ship.</span>
          </h1>
