...
const deliverables = [
  { title: "Web Design", body: "Full responsive design for marketing sites, SaaS platforms, and dashboards — structured for clarity at every breakpoint." },
  { title: "Mobile App Design", body: "iOS and Android interfaces that follow platform conventions while staying unmistakably on-brand." },
  { title: "Design Systems", body: "Component libraries, tokens, and documentation that let your team ship consistently without starting from scratch each time." },
];
    ...
    <main style={{ paddingTop: "76px" }}>
      <section style={{ background: "#1A0E08", padding: "80px 0 100px" }}>
        <div className="wrap">
          ...
          <p style={{ fontFamily: "JetBrains Mono, monospace", fontSize: "11px", letterSpacing: "0.16em", color: "#FF5300", textTransform: "uppercase", marginBottom: "20px" }}>Service — UI / UX Design</p>
          <h1 style={{ fontFamily: "Raleway, sans-serif", fontWeight: 800, fontSize: "clamp(40px, 5.5vw, 72px)", color: "#FAFAF8", lineHeight: 1.05, marginBottom: "24px", maxWidth: "700px" }}>
            Zero waste,<br /><span style={{ color: "#FF5300" }}>zero guesswork.</span>
          </h1>
          <p style={{ fontFamily: "DM Sans, sans-serif", fontSize: "clamp(16px, 1.8vw, 19px)", color: "#F3EBE1", opacity: 0.6, lineHeight: 1.8, maxWidth: "520px" }}>
            Digital interfaces engineered for clarity and longevity — clean architecture, intuitive flows, built to ship.
          </p>
        </div>
      </section>
      ...
      <section style={{ background: "#1A0E08", padding: "96px 0" }}>
        <div className="wrap" style={{ textAlign: "center" }}>
          <h2 style={{ fontFamily: "Raleway, sans-serif", fontWeight: 800, fontSize: "clamp(32px, 4vw, 52px)", color: "#FAFAF8", marginBottom: "20px" }}>Ready to design your product?</h2>
