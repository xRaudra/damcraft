...
const deliverables = [
  { title: "Spatial Concept", body: "Mood boards, material palettes, and spatial narratives that align the physical environment with your brand's core identity." },
  { title: "Design Development", body: "Floor plans, elevations, and 3D visualisations that communicate the space before a single wall is touched." },
  { title: "Brand Integration", body: "Wayfinding, signage, and environmental graphics that carry your visual identity consistently through every corner of the space." },
];
    ...
    <main style={{ paddingTop: "76px" }}>
      <section style={{ background: "#1A0E08", padding: "80px 0 100px" }}>
        <div className="wrap">
          ...
          <p style={{ fontFamily: "JetBrains Mono, monospace", fontSize: "11px", letterSpacing: "0.16em", color: "#FF5300", textTransform: "uppercase", marginBottom: "20px" }}>Service — Interior Design</p>
          <h1 style={{ fontFamily: "Raleway, sans-serif", fontWeight: 800, fontSize: "clamp(40px, 5.5vw, 72px)", color: "#FAFAF8", lineHeight: 1.05, marginBottom: "24px", maxWidth: "700px" }}>
            Spaces that<br /><span style={{ color: "#FF5300" }}>speak brand.</span>
          </h1>
          <p style={{ fontFamily: "DM Sans, sans-serif", fontSize: "clamp(16px, 1.8vw, 19px)", color: "#F3EBE1", opacity: 0.6, lineHeight: 1.8, maxWidth: "520px" }}>
            Commercial interiors and spatial branding — environments that make your brand felt before a word is spoken.
          </p>
        </div>
      </section>
      ...
      <section style={{ background: "#1A0E08", padding: "96px 0" }}>
        <div className="wrap" style={{ textAlign: "center" }}>
          <h2 style={{ fontFamily: "Raleway, sans-serif", fontWeight: 800, fontSize: "clamp(32px, 4vw, 52px)", color: "#FAFAF8", marginBottom: "20px" }}>Ready to design your space?</h2>
